...
interface MovieRepository {
    ...
    suspend fun getMovieCategoryDetails(categoryId: String, contentFilter: ContentFilter = ContentFilter.ALL, maxItems: Int = 400): MovieCategoryDetails
    suspend fun getMovieDetails(movieId: String): MovieDetails
    suspend fun getContentDetails(contentId: String, contentType: ContentType): MovieDetails
    suspend fun getTvShowDetails(tvShowId: String, season: Int = 1, episode: Int = 1): MovieDetails
