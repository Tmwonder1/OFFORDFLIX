...
fun DashboardScreen(
    ...
    openMovieDetailsWithType: (movieId: String, contentType: String) -> Unit,
    ...
    BackPressHandledArea(
        ...
        Body(
            ...
            openMovieDetailsWithType = openMovieDetailsWithType,
...
private fun Body(
    ...
    NavHost(
        ...
        composable(Screens.Shows()) {
            ShowsScreen(
                onTVShowClick = { movie -> 
                    // Use the proper callback that handles TV show content types
                    openMovieDetailsWithType(movie.id, movie.contentType.name)
                },
                onScroll = updateTopBarVisibility,
                isTopBarVisible = isTopBarVisible
            )
        ...
        composable(Screens.Favourites()) {
            FavouritesScreen(
                onMovieClick = { movieId -> openMovieDetailsScreen(movieId) },
                onScroll = updateTopBarVisibility,
                isTopBarVisible = isTopBarVisible
            )
        }
        composable(Screens.Search()) {
            SearchScreen(
                onMovieClick = { movie -> 
                    // Use the proper callback that handles content types
                    openMovieDetailsWithType(movie.id, movie.contentType.name)
                },
                onScroll = updateTopBarVisibility
            )
