...
android {
    namespace = "com.offordflix"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.offordflix"
        minSdk = 28
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    // Compose BOM - updated version with Material 3 support
    implementation(platform("androidx.compose:compose-bom:2024.02.00"))
    
    // Core Android TV - removing unavailable Compose TV dependencies for now
...
ksp {
    // Placeholder for any KSP-specific configuration if needed
}
